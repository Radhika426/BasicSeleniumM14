...
public class Day24_SelectClass_Assignment5 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		if(given_Url.equals(current_Url)) {
			...
			if(given_Title.contains(current_Title)) {
				...
				//Verify if specified option is present in "Sort By" dropdown menu and print its index
				...
				WebElement ele = driver.findElement(By.xpath("//option[.='Price: Low to High']"));
				int i=0;
				for (WebElement option : all_Options) {
					if(option.equals(ele)) {
